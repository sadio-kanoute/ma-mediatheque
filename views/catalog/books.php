...
<head>
    ...
    <title><?php echo e($title ?? 'Livres'); ?></title>
            ...
            <section class="search-filters">
                ...
                <form method="GET" action="<?php echo url('catalog/books'); ?>">
                    ...
                    <div class="search-bar">
                        ...
                        <input type="text" name="search_term" placeholder="Rechercher un livre..." class="search-input" value="<?php echo e($search_term ?? ''); ?>">
                        ...
                        <?php if (!empty($search_term) || ($search_genre ?? 'all') != 'all' || ($search_availability ?? 'all') != 'all'): ?>
                            ...
                            <a href="<?php echo url('catalog/books'); ?>" class="btn-effacer">Effacer</a>
                        <?php endif; ?>
                    </div>
